...
net.Receive("SBMG_Announce", function()
    ...
    if GetConVar("sbmg_ann_enforce"):GetBool() then
        ...
        local ann = GetConVar("sbmg_cl_ann_name"):GetString()
    ...
    if not GetConVar("sbmg_cl_ann_disabled"):GetBool() and snd then
        ...
        announcer_sound:PlayEx(GetConVar("sbmg_cl_ann_volume"):GetFloat(), 100)
    end
end)